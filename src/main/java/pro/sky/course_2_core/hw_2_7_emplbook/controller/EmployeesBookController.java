package pro.sky.course_2_core.hw_2_7_emplbook.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;
import pro.sky.course_2_core.employee.model.Employee;
import pro.sky.course_2_core.hw_2_7_emplbook.service.EmployeesBookService;
...
public class EmployeesBookController {
    ...
    public Employee findMaxWageEmployeeInDepartment(int departmentId) {
        return employeesBookService.findMaxWageEmployeeInDepartment(departmentId);
    }

    @GetMapping("/find-min-wage-employee-in-department")
    public Employee findMinWageEmployeeInDepartment(int departmentId) {
        return employeesBookService.findMinWageEmployeeInDepartment(departmentId);
    }
